...
const ComparadorInvestimentos = memo(function ComparadorInvestimentos({
  ...
  return (
    ...
    >
      {/* Cabeçalho */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between p-4 lg:p-6 border-b border-gray-200 dark:border-gray-700 space-y-4 lg:space-y-0">
          ...
          {comparacoes.length > 0 && (
            <div className="flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1 w-full sm:w-auto">
              <button
                ...
                className={`flex-1 sm:flex-none px-2 sm:px-3 py-1 text-xs rounded-md transition-colors ${
                  visualizacao === 'lista'
          ...
          <div className="flex flex-wrap gap-2 w-full sm:w-auto">
            ...
            {comparacoes.length > 0 && (
              <button
                ...
                className="flex items-center justify-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-2 text-xs sm:text-sm bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 rounded-lg transition-colors flex-1 sm:flex-none"
              >
            ...
            {comparacoes.length < 3 && (
              <button
                ...
                className="flex items-center justify-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-2 text-xs sm:text-sm bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-800 rounded-lg transition-colors flex-1 sm:flex-none"
              >
            ...
            {comparacoes.length > 0 && (
              <button
                ...
                className="flex items-center justify-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-2 text-xs sm:text-sm bg-red-100 dark:bg-red-900 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-800 rounded-lg transition-colors flex-1 sm:flex-none"
              >
                <X className="w-3 h-3 sm:w-4 sm:h-4" />
                <span className="hidden sm:inline">Limpar</span>
                <span className="sm:hidden">Lmp</span>
              </button>
            )}
          </div>
        </div>
